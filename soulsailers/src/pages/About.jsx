...
const About = () => {
  ...
  const team = [
    { name: 'Arjun Mehta', role: 'Founder & CEO', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300' },
    { name: 'Priya Sharma', role: 'Head of Operations', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=300' },
    { name: 'Rahul Verma', role: 'Travel Expert', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300' },
    { name: 'Anita Patel', role: 'Content Lead', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300' },
  ]
