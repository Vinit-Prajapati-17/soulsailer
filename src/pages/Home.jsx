...
import { MapPin, Compass, Calendar, Users, Star, ArrowRight, Sparkles, Navigation, Clock, Map, UserCheck, Award, Shield, CheckCircle, Zap, Globe, Heart, Gem, Plane, Route, Camera, Users2, MapPinned, Compass as CompassIcon, Clock4, ThumbsUp } from 'lucide-react'
        ...
        <div className="container">
          ...
          <div className="features-journey">
            ...
            <div className="features-items">
              {[
                { icon: <CompassIcon size={60} />, title: 'Expert Curation', desc: 'Hand-picked destinations and experiences by travel experts' },
                { icon: <Route size={60} />, title: 'Detailed Itineraries', desc: 'Day-by-day plans with timings, tips, and local insights' },
                { icon: <Camera size={60} />, title: 'Local Experiences', desc: 'Authentic cultural experiences and hidden gems' },
                { icon: <ThumbsUp size={60} />, title: 'Community Reviews', desc: 'Real traveler reviews and recommendations' },
              ].map((feature, index) => (
                <motion.div 
                  key={index}
      ...
      <section className="why-choose section">
        <div className="container">
          ...
          >
            ...
            <div className="trust-item">
              <div className="trust-icon"><Star size={24} /></div>
              <span>100% Satisfaction</span>
            </div>
            <div className="trust-item">
              <div className="trust-icon"><Plane size={24} /></div>
